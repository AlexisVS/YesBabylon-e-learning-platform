...
const routes: Routes = [
  ...
  {path: 'account', loadChildren: () => import('./in/account/account.module').then(m => m.AppInAccountModule)},
  {path: 'courses', loadChildren: () => import('./in/courses/courses.module').then(m => m.AppInCoursesModule)},
  {path: 'course/:id', loadChildren: () => import('./in/course/course.module').then(m => m.AppInCourseModule)},
];
